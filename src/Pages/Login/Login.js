    ...
    return (
        <div data-theme="autumn"  className='' >
            <div  className="hero min-h-screen  " >
                <div  className='hero-content flex-col lg:flex-row-reverse hero min-h-screen'>
                    <div className="text-center lg:text-left">
                        <h1  className="text-5xl font-bold text-rose-800">Login</h1>
                    </div>
                    <div data-theme="autumn" className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
